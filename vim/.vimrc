...
" 		call append(line(".")+1, "	> Author: Haosheng Zhang") 
" 		call append(line(".")+2, "	> Mail: haosheng.zhang@yitu-inc.com") 
...
Plugin 'https://github.com/ivanov/vim-ipython.git'
Plugin 'Auto-Pairs'
...
let g:ycm_global_ycm_extra_conf = '/home/hszhang/.vim/bundle/YouCompleteMe/third_party/ycmd/cpp/ycm/.ycm_extra_conf.py'
